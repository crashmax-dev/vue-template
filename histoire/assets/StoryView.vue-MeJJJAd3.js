...
function useStoryDoc(story) {
	...
	watchEffect(async () => {
		...
		if (markdownFiles[mdKey]) {
			renderedDoc.value = (await markdownFiles[mdKey]()).html;
			return;
		}
		let comp = story.value.file?.component;
		if (comp) {
			if (comp.__asyncResolved) comp = comp.__asyncResolved;
			else if (comp.__asyncLoader) comp = await comp.__asyncLoader();
			else if (typeof comp === "function") try {
				comp = await comp();
			} catch (e) {}
	...
	setup(__props, { emit: __emit }) {
		...
		function getHash() {
			...
			if (histoireConfig.routerMode === "hash") {
				...
				if (index !== -1) return hash.slice(index);
				else return;
			}
			return hash;
		}
		...
		async function patchAnchorLinks() {
			...
			if (histoireConfig.routerMode === "hash" && renderedEl.value) {
				...
				for (const link of links) {
					...
					if (href) link.setAttribute("href", `#${route.path + href}`);
				}
			}
		}
		watch(renderedDoc, () => {
		...
		return (_ctx, _cache) => {
			...
			}, [createCommentVNode("", true), !unref(renderedDoc) ? (openBlock(), createBlock(BaseEmpty, { key: 1 }, {
...
var _hoisted_2$17 = { class: "htw-flex htw-flex-col htw-items-stretch" };
var overflowButtonWidth = 32;
var _sfc_main$33 = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		useResizeObserver(el, (entries) => {
			availableWidth.value = entries[0].contentRect.width - overflowButtonWidth;
		});
		...
		const visibleChildrenCount = computed(() => {
			...
			for (let i = 0; i < c.length; i++) {
				width += c[i].width;
				if (width > availableWidth.value) return i;
			}
			return c.length;
		});
		const ChildWrapper = {
			...
			setup(props, { slots }) {
				...
				useResizeObserver(el2, (entries) => {
					...
					if (!children.value.has(el2.value)) children.value.set(el2.value, state);
					state.width = width;
				});
				onBeforeUnmount(() => {
				...
				return () => h("div", {
					ref: el2,
					style: { visibility: visible.value ? "visible" : "hidden" }
				}, slots.default());
			}
		};
		...
		return (_ctx, _cache) => {
			...
			return openBlock(), createElementBlock("div", {
				...
				popper: withCtx(() => [createBaseVNode("div", _hoisted_2$17, [createVNode(ChildrenSlice, { start: visibleChildrenCount.value }, {
					default: withCtx(() => [renderSlot(_ctx.$slots, "overflow")]),
					_: 3
				}, 8, ["start"])])]),
				default: withCtx(() => [createBaseVNode("div", _hoisted_1$28, [createVNode(unref(Icon), {
...
function _sfc_render$4(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createBlock(_component_router_link, mergeProps({ class: "histoire-base-overflow-tab" }, _ctx.$attrs, { custom: "" }), {
		default: withCtx(({ isActive, isExactActive, href, navigate }) => [createBaseVNode("a", mergeProps(_ctx.$attrs, {
			href,
			class: ["htw-px-4 htw-h-10 htw-min-w-[150px] htw-inline-flex htw-items-center hover:htw-bg-primary-50 dark:hover:htw-bg-primary-900 htw-relative htw-text-gray-900 dark:htw-text-gray-100", { "htw-text-primary-500 dark:htw-text-primary-400": _ctx.matched != null ? _ctx.matched : _ctx.exact && isExactActive || !_ctx.exact && isActive }],
			onClick: navigate
		}), [renderSlot(_ctx.$slots, "default"), createVNode(Transition, { name: "__histoire-scale-y" }, {
			default: withCtx(() => [(_ctx.matched != null ? _ctx.matched : _ctx.exact && isExactActive || !_ctx.exact && isActive) ? (openBlock(), createElementBlock("div", _hoisted_2$16)) : createCommentVNode("", true)]),
			_: 2
		}, 1024)], 16, _hoisted_1$27)]),
		_: 3
	}, 16);
}
...
function _sfc_render$3(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createBlock(_component_router_link, mergeProps({ class: "histoire-base-tab" }, _ctx.$attrs, { custom: "" }), {
		default: withCtx(({ isActive, isExactActive, href, navigate }) => [createBaseVNode("a", mergeProps(_ctx.$attrs, {
			href,
			class: ["htw-px-4 htw-h-full htw-inline-flex htw-items-center hover:htw-bg-primary-50 dark:hover:htw-bg-primary-900 htw-relative htw-text-gray-900 dark:htw-text-gray-100", { "htw-text-primary-500 dark:htw-text-primary-400": _ctx.matched != null ? _ctx.matched : _ctx.exact && isExactActive || !_ctx.exact && isActive }],
			onClick: navigate
		}), [renderSlot(_ctx.$slots, "default"), createVNode(Transition, { name: "__histoire-scale-x" }, {
			default: withCtx(() => [(_ctx.matched != null ? _ctx.matched : _ctx.exact && isExactActive || !_ctx.exact && isActive) ? (openBlock(), createElementBlock("div", _hoisted_2$15)) : createCommentVNode("", true)]),
			_: 2
		}, 1024)], 16, _hoisted_1$26)]),
		_: 3
	}, 16);
}
...
function _sfc_render$2(_ctx, _cache) {
	return openBlock(), createElementBlock("span", _hoisted_1$25, [renderSlot(_ctx.$slots, "default")]);
}
...
var _sfc_main$29 = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		const { story } = toRefs(__props);
		const { renderedDoc } = useStoryDoc(story);
		const eventsStore = useEventsStore();
		const hasEvents = computed(() => eventsStore.events.length);
		return (_ctx, _cache) => {
			return openBlock(), createBlock(_sfc_main$33, { class: "histoire-pane-tabs htw-h-10 htw-flex-none htw-border-b htw-border-gray-100 dark:htw-border-gray-750" }, {
				overflow: withCtx(() => [
					createVNode(BaseOverflowTab, {
						...
						default: withCtx(() => [..._cache[3] || (_cache[3] = [createTextVNode(" Controls ", -1)])]),
						_: 1
					}, 8, ["to", "matched"]),
					createVNode(BaseOverflowTab, {
						to: {
						...
						class: normalizeClass({ "opacity-50": !unref(renderedDoc) })
					}, {
						default: withCtx(() => [..._cache[4] || (_cache[4] = [createTextVNode(" Docs ", -1)])]),
						_: 1
					}, 8, [
						"to",
						"matched",
					...
					createVNode(BaseOverflowTab, {
						...
						class: normalizeClass({ "htw-opacity-50": !hasEvents.value })
					}, {
						default: withCtx(() => [_cache[5] || (_cache[5] = createTextVNode(" Events ", -1)), unref(eventsStore).unseen ? (openBlock(), createBlock(BaseTag, { key: 0 }, {
							default: withCtx(() => [createTextVNode(toDisplayString(unref(eventsStore).unseen <= 99 ? unref(eventsStore).unseen : "99+"), 1)]),
							_: 1
				...
				default: withCtx(() => [
					createVNode(BaseTab, {
						...
						default: withCtx(() => [..._cache[0] || (_cache[0] = [createTextVNode(" Controls ", -1)])]),
						_: 1
					}, 8, ["to", "matched"]),
					createVNode(BaseTab, {
						to: {
						...
						matched: _ctx.$route.query.tab === "docs",
						class: normalizeClass({ "htw-opacity-50": !unref(renderedDoc) })
					}, {
						default: withCtx(() => [..._cache[1] || (_cache[1] = [createTextVNode(" Docs ", -1)])]),
						_: 1
					}, 8, [
						"to",
						"matched",
					...
					createVNode(BaseTab, {
						...
						default: withCtx(() => [_cache[2] || (_cache[2] = createTextVNode(" Events ", -1)), unref(eventsStore).unseen ? (openBlock(), createBlock(BaseTag, { key: 0 }, {
							default: withCtx(() => [createTextVNode(toDisplayString(unref(eventsStore).unseen <= 99 ? unref(eventsStore).unseen : "99+"), 1)]),
							_: 1
						})) : createCommentVNode("", true)]),
						_: 1
	...
	setup(__props) {
		...
		const comp = computed(() => {
			switch (props.definition.types?.[0]) {
				case "string": return s0;
				case "number": return n0;
				case "boolean": return e0;
				default: return d0;
			}
		});
		const model = computed({
			...
			set: (value) => {
				if (!props.variant.state._hPropState[props.component.index]) props.variant.state._hPropState[props.component.index] = {};
				props.variant.state._hPropState[props.component.index][props.definition.name] = value;
			}
		});
		function reset() {
			if (props.variant.state._hPropState[props.component.index]) delete props.variant.state._hPropState[props.component.index][props.definition.name];
		}
		...
		return (_ctx, _cache) => {
			...
			return comp.value ? (openBlock(), createBlock(resolveDynamicComponent(comp.value), {
				...
				actions: withCtx(() => [withDirectives(createVNode(unref(Icon), {
					icon: "carbon:erase",
					class: normalizeClass(["htw-cursor-pointer htw-w-4 htw-h-4 hover:htw-text-primary-500 dark:hover:htw-text-primary-400 htw-text-gray-900 dark:htw-text-gray-100", [canReset.value ? "htw-opacity-50 hover:htw-opacity-100" : "htw-opacity-25 htw-pointer-events-none"]]),
					onClick: _cache[0] || (_cache[0] = withModifiers(($event) => reset(), ["stop"]))
				}, null, 8, ["class"]), [[_directive_tooltip, "Remove override"]])]),
				_: 1
			}, 8, [
				"modelValue",
				"placeholder",
...
var _sfc_main$27 = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		return (_ctx, _cache) => {
			const _directive_tooltip = resolveDirective("tooltip");
			return openBlock(), createElementBlock("div", _hoisted_1$24, [createBaseVNode("div", _hoisted_2$14, [withDirectives(createVNode(unref(Icon), {
				icon: "carbon:flash",
				class: "htw-w-4 htw-h-4 htw-text-primary-500 htw-flex-none"
			}, null, 512), [[_directive_tooltip, "Auto-detected props"]]), createBaseVNode("div", null, [
...
var _sfc_main$25 = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			const _directive_tooltip = resolveDirective("tooltip");
			return openBlock(), createElementBlock("div", _hoisted_1$23, [createBaseVNode("div", _hoisted_2$13, [withDirectives(createVNode(unref(Icon), {
				icon: "carbon:data-vis-1",
				class: "htw-w-4 htw-h-4 htw-text-primary-500 htw-flex-none"
			}, null, 512), [[_directive_tooltip, "Auto-detected state"]]), _cache[0] || (_cache[0] = createBaseVNode("div", null, " State ", -1))]), (openBlock(true), createElementBlock(Fragment, null, renderList(stateKeys.value, (key) => {
				return openBlock(), createBlock(_sfc_main$26, {
					key,
					item: key,
					variant: __props.variant
				}, null, 8, ["item", "variant"]);
...
var _sfc_main$24 = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		const formattedOptions = computed(() => {
			if (Array.isArray(props.options)) return Object.fromEntries(props.options.map((value) => [value, value]));
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(unref(kt), {
				...
				popper: withCtx(({ hide }) => [createBaseVNode("div", _hoisted_3$11, [(openBlock(true), createElementBlock(Fragment, null, renderList(formattedOptions.value, (label, value) => {
					return openBlock(), createElementBlock("div", mergeProps({ ref_for: true }, {
						...
						key: label,
						class: ["htw-px-2 htw-py-1 htw-cursor-pointer hover:htw-bg-primary-100 dark:hover:htw-bg-primary-700", { "htw-bg-primary-200 dark:htw-bg-primary-800": props.modelValue === value }],
						onClick: ($event) => selectValue(value, hide)
					}), [renderSlot(_ctx.$slots, "option", {
						label,
						value
					}, () => [createTextVNode(toDisplayString(label), 1)])], 16, _hoisted_4$7);
				}), 128))])]),
				default: withCtx(() => [createBaseVNode("div", _hoisted_1$22, [createBaseVNode("div", _hoisted_2$12, [renderSlot(_ctx.$slots, "default", { label: selectedLabel.value }, () => [createTextVNode(toDisplayString(selectedLabel.value), 1)])]), createVNode(unref(Icon), {
...
var _hoisted_4$6 = { class: "htw-flex-1 htw-truncate" };
var _hoisted_5$5 = { class: "htw-flex htw-gap-2 htw-items-center" };
var _hoisted_6$3 = { class: "htw-flex-1 htw-truncate" };
...
var _sfc_main$23 = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		function applyPreset(id) {
			if (id === DEFAULT_ID) resetState();
			else if (presetStates.value.has(id)) applyState(props.variant.state, clone(toRawDeep(presetStates.value.get(id).state)));
		}
		onMounted(() => {
			if (selectedOption.value !== DEFAULT_ID) applyPreset(selectedOption.value);
		});
		const input = ref();
		const select = ref();
		...
		function deletePreset(id) {
			...
			if (selectedOption.value === id) resetState();
		...
		return (_ctx, _cache) => {
			...
			return openBlock(), createElementBlock("div", _hoisted_1$21, [
				createBaseVNode("div", {
					...
					onKeydown: [_cache[4] || (_cache[4] = withKeys(($event) => stopEditing(), ["enter"])), _cache[5] || (_cache[5] = withKeys(($event) => stopEditing(), ["escape"]))],
					onSelect: _cache[6] || (_cache[6] = (id) => applyPreset(id))
				}, {
					default: withCtx(({ label }) => [isEditing.value ? withDirectives((openBlock(), createElementBlock("input", {
						key: 0,
						ref_key: "input",
						ref: input,
					...
					}, null, 8, _hoisted_2$11)), [[vModelText, unref(presetStates).get(unref(selectedOption)).label]]) : (openBlock(), createElementBlock("div", _hoisted_3$10, [createBaseVNode("span", _hoisted_4$6, toDisplayString(label), 1), canEdit.value ? withDirectives((openBlock(), createBlock(unref(Icon), {
						key: 0,
						icon: "carbon:edit",
					...
					}, null, 512)), [[_directive_tooltip, "Rename this preset"]]) : createCommentVNode("", true)]))]),
					option: withCtx(({ label, value }) => [createBaseVNode("div", _hoisted_5$5, [createBaseVNode("span", _hoisted_6$3, toDisplayString(label), 1), value !== DEFAULT_ID ? withDirectives((openBlock(), createBlock(unref(Icon), {
						key: 0,
						icon: "carbon:trash-can",
						class: "htw-flex-none htw-cursor-pointer htw-w-4 htw-h-4 hover:htw-text-primary-500 htw-opacity-50 hover:htw-opacity-100 dark:hover:htw-text-primary-400 htw-text-gray-900 dark:htw-text-gray-100",
						onClick: withModifiers(($event) => deletePreset(value), ["stop"])
					}, null, 8, ["onClick"])), [[_directive_tooltip, "Delete this preset"]]) : createCommentVNode("", true)])]),
					_: 1
				}, 8, ["modelValue", "options"])], 512),
				withDirectives(createVNode(unref(Icon), {
					icon: savedNotif.value ? "carbon:checkmark" : "carbon:save",
					class: normalizeClass(["htw-cursor-pointer htw-w-4 htw-h-4 hover:htw-text-primary-500 dark:hover:htw-text-primary-400 htw-text-gray-900 dark:htw-text-gray-100", [canEdit.value ? "htw-opacity-50 hover:htw-opacity-100" : "htw-opacity-25 htw-pointer-events-none"]]),
					onClick: _cache[7] || (_cache[7] = ($event) => savePreset())
				}, null, 8, ["icon", "class"]), [[_directive_tooltip, savedNotif.value ? "Saved!" : canEdit.value ? "Save to preset" : null]]),
				withDirectives(createVNode(unref(Icon), {
					icon: "carbon:add-alt",
				...
				}, null, 512), [[_directive_tooltip, "Create new preset"]]),
				withDirectives(createVNode(unref(Icon), {
					icon: "carbon:reset",
					class: "htw-cursor-pointer htw-w-4 htw-h-4 hover:htw-text-primary-500 htw-opacity-50 hover:htw-opacity-100 dark:hover:htw-text-primary-400 htw-text-gray-900 dark:htw-text-gray-100",
					onClick: _cache[9] || (_cache[9] = ($event) => resetState())
				}, null, 512), [[_directive_tooltip, "Reset to initial state"]])
			]);
		};
	}
});
...
var _hoisted_2$10 = { class: "htw-h-9 htw-flex-none htw-px-2 htw-flex htw-items-center" };
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1$20, [
				createBaseVNode("div", _hoisted_2$10, [ready.value || !hasCustomControls.value ? (openBlock(), createBlock(_sfc_main$23, {
					key: 0,
					story: __props.story,
					variant: __props.variant
				}, null, 8, ["story", "variant"])) : createCommentVNode("", true)]),
				hasCustomControls.value ? (openBlock(), createBlock(_sfc_main$36, {
				...
				}, null, 8, ["variant", "story"])) : hasInitState.value ? (openBlock(), createElementBlock("div", _hoisted_3$9, [createVNode(_sfc_main$25, {
					class: "htw-flex-none htw-my-2",
					variant: __props.variant
				}, null, 8, ["variant"])])) : !__props.variant.state?._hPropDefs?.length ? (openBlock(), createBlock(BaseEmpty, { key: 2 }, {
					default: withCtx(() => [createVNode(unref(Icon), {
				...
				__props.variant.state?._hPropDefs?.length ? (openBlock(), createElementBlock("div", _hoisted_4$5, [(openBlock(true), createElementBlock(Fragment, null, renderList(__props.variant.state._hPropDefs, (def, index) => {
...
var _hoisted_2$9 = { class: "htw-overflow-auto htw-max-w-[400px] htw-max-h-[400px]" };
var _hoisted_3$8 = { class: "htw-p-4" };
	...
	setup(__props) {
		...
		const formattedArgument = computed(() => {
			switch (typeof props.event.argument) {
				case "string": return `"${props.event.argument}"`;
				case "object": return `{ ${Object.keys(props.event.argument).map((key) => `${key}: ${props.event.argument[key]}`).join(", ")} }`;
				default: return props.event.argument;
			}
		});
		return (_ctx, _cache) => {
			const _component_VDropdown = resolveComponent("VDropdown");
			return openBlock(), createBlock(_component_VDropdown, {
				...
				default: withCtx(({ shown }) => [createBaseVNode("div", { class: normalizeClass(["group-hover:htw-bg-primary-100 dark:group-hover:htw-bg-primary-700 htw-cursor-pointer htw-py-2 htw-px-4 htw-flex htw-items-baseline htw-gap-1 htw-leading-normal", [shown ? "htw-bg-primary-50 dark:htw-bg-primary-600" : "group-odd:htw-bg-gray-100/50 dark:group-odd:htw-bg-gray-750/40"]]) }, [createBaseVNode("span", { class: normalizeClass({ "htw-text-primary-500": shown }) }, toDisplayString(__props.event.name), 3), __props.event.argument ? (openBlock(), createElementBlock("span", _hoisted_1$19, toDisplayString(formattedArgument.value), 1)) : createCommentVNode("", true)], 2)]),
				popper: withCtx(() => [createBaseVNode("div", _hoisted_2$9, [createBaseVNode("pre", _hoisted_3$8, toDisplayString(__props.event.argument), 1)])]),
				_: 1
			});
		};
	}
...
var _sfc_main$20 = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		async function resetUnseen() {
			if (eventsStore.unseen > 0) eventsStore.unseen = 0;
			await nextTick();
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", {
				...
				_: 1
			})) : (openBlock(), createElementBlock("div", _hoisted_1$18, [(openBlock(true), createElementBlock(Fragment, null, renderList(unref(eventsStore).events, (event, key) => {
...
var _hoisted_3$7 = { class: "htw-flex htw-flex-none htw-gap-px htw-h-full htw-py-2" };
var _hoisted_4$4 = {
	key: 1,
...
var StorySourceCode = /* @__PURE__ */ _export_sfc(/* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		watchEffect(async () => {
			...
			if (clientPlugin) generateSourceCodeFn.value = markRaw((await clientPlugin()).generateSourceCode);
		});
		...
		watch(() => [props.variant, generateSourceCodeFn.value], async () => {
			...
			try {
				if (props.variant.source) dynamicSourceCode.value = props.variant.source;
				else if (props.variant.slots?.().source) {
					const source = props.variant.slots?.().source()[0].children;
					if (source) dynamicSourceCode.value = await unindent(source);
				} else dynamicSourceCode.value = await generateSourceCodeFn.value(props.variant);
			} catch (e) {
				console.error(e);
				error.value = e.message;
			}
			if (!dynamicSourceCode.value) displayedSource.value = "static";
		}, {
			deep: true,
			immediate: true
		});
		...
		watch(() => [props.story, props.story?.file?.source], async () => {
			...
			if (sourceLoader) staticSourceCode.value = (await sourceLoader()).default;
		}, { immediate: true });
		const displayedSource = ref("dynamic");
		const displayedSourceCode = computed(() => {
			if (displayedSource.value === "dynamic") return dynamicSourceCode.value;
		...
		function onScroll(event) {
			if (sourceHtml.value) lastScroll = event.target.scrollTop;
		}
		watch(sourceHtml, async () => {
			await nextTick();
			if (scroller.value) scroller.value.scrollTop = lastScroll;
		});
		return (_ctx, _cache) => {
			const _directive_tooltip = resolveDirective("tooltip");
			return openBlock(), createElementBlock("div", _hoisted_1$17, [!error.value ? (openBlock(), createElementBlock("div", _hoisted_2$8, [
				...
				createBaseVNode("div", _hoisted_3$7, [withDirectives((openBlock(), createElementBlock("button", {
					class: normalizeClass(["htw-flex htw-items-center htw-gap-1 htw-h-full htw-px-1 htw-bg-gray-500/10 htw-rounded-l htw-transition-all htw-ease-[cubic-bezier(0,1,.6,1)] htw-duration-300 htw-overflow-hidden", [displayedSource.value !== "dynamic" ? "htw-max-w-6 htw-opacity-70" : "htw-max-w-[82px] htw-text-primary-600 dark:htw-text-primary-400", dynamicSourceCode.value ? "htw-cursor-pointer hover:htw-bg-gray-500/30 active:htw-bg-gray-600/50" : "htw-opacity-50"]]),
				...
				}), createBaseVNode("span", { class: normalizeClass(["transition-opacity duration-300", { "opacity-0": displayedSource.value !== "dynamic" }]) }, " Dynamic ", 2)], 2)), [[_directive_tooltip, !dynamicSourceCode.value ? "Dynamic source code is not available" : displayedSource.value !== "dynamic" ? "Switch to dynamic source" : null]]), withDirectives((openBlock(), createElementBlock("button", {
					class: normalizeClass(["htw-flex htw-items-center htw-gap-1 htw-h-full htw-px-1 htw-bg-gray-500/10 htw-rounded-r htw-transition-all htw-ease-[cubic-bezier(0,1,.6,1)] htw-duration-300 htw-overflow-hidden", [displayedSource.value !== "static" ? "htw-max-w-6 htw-opacity-70" : "htw-max-w-[63px] htw-text-primary-600 dark:htw-text-primary-400", staticSourceCode.value ? "htw-cursor-pointer hover:htw-bg-gray-500/30 active:htw-bg-gray-600/50" : "htw-opacity-50"]]),
					onClick: _cache[1] || (_cache[1] = ($event) => staticSourceCode.value && (displayedSource.value = "static"))
				}, [createVNode(unref(Icon), {
					icon: "carbon:document",
					class: "htw-w-4 htw-h-4 htw-flex-none"
				}), createBaseVNode("span", { class: normalizeClass(["transition-opacity duration-300", { "opacity-0": displayedSource.value !== "static" }]) }, " Static ", 2)], 2)), [[_directive_tooltip, !staticSourceCode.value ? "Static source code is not available" : displayedSource.value !== "static" ? "Switch to static source" : null]])]),
				createVNode(unref(f0), {
					content: displayedSourceCode.value,
					class: "htw-flex-none"
				}, null, 8, ["content"])
			])) : createCommentVNode("", true), error.value ? (openBlock(), createElementBlock("div", _hoisted_4$4, " Error: " + toDisplayString(error.value), 1)) : !displayedSourceCode.value ? (openBlock(), createBlock(BaseEmpty, { key: 2 }, {
				default: withCtx(() => [createVNode(unref(Icon), {
	...
	setup(__props) {
		...
		const panelContentComponent = computed(() => {
			switch (route.query.tab) {
				case "docs": return _sfc_main$34;
				case "events": return _sfc_main$20;
				default: return _sfc_main$22;
			}
		});
		return (_ctx, _cache) => {
			return !unref(storyStore).currentVariant ? (openBlock(), createBlock(BaseEmpty, {
				...
				default: withCtx(() => [..._cache[0] || (_cache[0] = [createBaseVNode("span", null, "Select a variant", -1)])]),
				_: 1
				...
				default: withCtx(() => [..._cache[1] || (_cache[1] = [createBaseVNode("span", null, "Loading...", -1)])]),
				_: 1
				...
				first: withCtx(() => [createBaseVNode("div", _hoisted_1$16, [createVNode(_sfc_main$29, {
					story: unref(storyStore).currentStory,
					variant: unref(storyStore).currentVariant
				}, null, 8, ["story", "variant"]), (openBlock(), createBlock(resolveDynamicComponent(panelContentComponent.value), {
					story: unref(storyStore).currentStory,
					variant: unref(storyStore).currentVariant,
					class: "htw-h-full htw-overflow-auto"
				}, null, 8, ["story", "variant"]))])]),
				last: withCtx(() => [createVNode(StorySourceCode, {
					story: unref(storyStore).currentStory,
					variant: unref(storyStore).currentVariant,
					class: "htw-h-full"
				}, null, 8, ["story", "variant"])]),
...
var _hoisted_3$6 = ["stroke-dasharray", "stroke-dashoffset"];
var _sfc_main$17 = /* @__PURE__ */ defineComponent({
	...
	emits: { "update:modelValue": (_newValue) => true },
	setup(__props, { emit: __emit }) {
		const props = __props;
		const emit = __emit;
		function toggle() {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", {
				...
				onKeydown: [_cache[1] || (_cache[1] = withKeys(withModifiers(($event) => toggle(), ["prevent"]), ["enter"])), _cache[2] || (_cache[2] = withKeys(withModifiers(($event) => toggle(), ["prevent"]), ["space"]))]
			}, [createBaseVNode("div", _hoisted_1$15, [createBaseVNode("div", { class: normalizeClass(["htw-border group-active:htw-bg-gray-500/20 htw-rounded-sm htw-box-border htw-absolute htw-inset-0 htw-transition-border htw-duration-150 htw-ease-out", [__props.modelValue ? "htw-border-primary-500 htw-border-8" : "htw-border-black/25 dark:htw-border-white/25 htw-delay-150"]]) }, null, 2), (openBlock(), createElementBlock("svg", _hoisted_2$7, [createBaseVNode("path", {
				ref_key: "path",
				ref: path,
				d: "m 4 12 l 5 5 l 10 -10",
				fill: "none",
				class: normalizeClass(["htw-stroke-white htw-stroke-2 htw-duration-200 htw-ease-in-out", [animationEnabled.value ? "htw-transition-all" : "htw-transition-none", { "htw-delay-150": __props.modelValue }]]),
				"stroke-dasharray": dasharray.value,
				"stroke-dashoffset": dashoffset.value
			}, null, 10, _hoisted_3$6)]))]), renderSlot(_ctx.$slots, "default")], 32);
		};
	}
});
//#endregion
...
var _hoisted_6$1 = { class: "htw-mr-auto" };
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			...
			return unref(histoireConfig).backgroundPresets.length ? (openBlock(), createBlock(_component_VDropdown, {
				...
				popper: withCtx(({ hide }) => [createBaseVNode("div", _hoisted_4$3, [createVNode(_sfc_main$17, {
					modelValue: unref(settings).checkerboard,
					"onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => unref(settings).checkerboard = $event)
				}, {
					default: withCtx(() => [..._cache[1] || (_cache[1] = [createTextVNode(" Checkerboard ", -1)])]),
					_: 1
				}, 8, ["modelValue"]), (openBlock(true), createElementBlock(Fragment, null, renderList(unref(histoireConfig).backgroundPresets, (option, index) => {
					return openBlock(), createElementBlock("button", {
						key: index,
						class: normalizeClass(["htw-px-4 htw-py-3 htw-cursor-pointer htw-text-left htw-flex htw-items-baseline htw-gap-4", [unref(settings).backgroundColor === option.color ? "htw-bg-primary-500 hover:htw-bg-primary-600 htw-text-white dark:htw-text-black" : "htw-bg-transparent hover:htw-bg-primary-100 dark:hover:htw-bg-primary-700"]]),
						onClick: ($event) => {
							unref(settings).backgroundColor = option.color;
							hide();
						}
					}, [createBaseVNode("span", _hoisted_6$1, toDisplayString(option.label), 1), option.color !== "$checkerboard" ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [createBaseVNode("span", _hoisted_7$1, toDisplayString(option.color), 1), createBaseVNode("div", {
					...
					}, [option.contrastColor ? (openBlock(), createElementBlock("span", _hoisted_8$1, "a")) : createCommentVNode("", true)], 4)], 64)) : createCommentVNode("", true)], 10, _hoisted_5$3);
				}), 128))])]),
				default: withCtx(() => [withDirectives((openBlock(), createElementBlock("div", _hoisted_1$14, [createBaseVNode("div", _hoisted_2$6, [contrastColor.value ? (openBlock(), createElementBlock("span", _hoisted_3$5, "a")) : createCommentVNode("", true)]), createVNode(unref(Icon), {
					icon: "carbon:caret-down",
					class: "htw-w-4 htw-h-4 htw-opacity-50 group-hover:htw-opacity-100"
...
var _sfc_main$15 = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			...
			}, null, 8, ["icon"])])), [[_directive_tooltip, `Switch to text direction ${unref(settings).textDirection === "ltr" ? "Right to Left" : "Left to Right"}`]]);
		};
	}
});
//#endregion
...
async function getSourceCode(story, variant) {
	if (variant.source) return variant.source;
		...
		if (source) return unindent(source);
	} else {
		const clientPlugin = clientSupportPlugins[story.file?.supportPluginId];
		if (clientPlugin) return (await clientPlugin()).generateSourceCode(variant);
	}
...
function useCurrentVariantRoute(variant) {
	const route = useRoute();
	return {
		isActive: computed(() => route.query.variantId === variant.value.id),
...
function _sfc_render$1(_ctx, _cache) {
	return openBlock(), createElementBlock("svg", _hoisted_1$13, [..._cache[0] || (_cache[0] = [createBaseVNode("pattern", {
		id: "checkerboard",
		width: "64",
		height: "64",
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			...
			return withDirectives((openBlock(), createElementBlock("a", {
				...
				icon: "carbon:launch",
				class: "htw-w-4 htw-h-4"
			})], 8, _hoisted_1$12)), [[_directive_tooltip, "Open variant in new tab"]]);
		};
	}
});
//#endregion
...
var StoryVariantGridItem = /* @__PURE__ */ _export_sfc(/* @__PURE__ */ defineComponent({
	...
	emits: { resize: (_width, _height) => true },
	setup(__props, { emit: __emit }) {
		useCssVars((_ctx) => ({
		...
		Object.assign(props.variant, { previewReady: false });
		function onReady() {
			Object.assign(props.variant, { previewReady: true });
		}
		const router = useRouter();
		...
		return (_ctx, _cache) => {
			...
			return openBlock(), createElementBlock("div", {
			...
			}, [createBaseVNode("div", _hoisted_1$11, [withDirectives((openBlock(), createBlock(_component_RouterLink, {
				...
				}, null, 8, ["icon", "class"]), createBaseVNode("span", _hoisted_2$5, toDisplayString(unref(variant).title), 1)]),
				_: 1
			}, 8, ["to", "class"])), [[_directive_tooltip, unref(variant).title]]), createBaseVNode("div", _hoisted_3$4, [createVNode(unref(f0), { content: () => unref(getSourceCode)(__props.story, unref(variant)) }, null, 8, ["content"]), createVNode(_sfc_main$13, {
				variant: unref(variant),
				story: __props.story
			}, null, 8, ["variant", "story"])])]), createBaseVNode("div", {
				...
				}, [(openBlock(), createBlock(_sfc_main$36, {
					key: `${__props.story.id}-${unref(variant).id}`,
					variant: unref(variant),
					story: __props.story,
					dir: unref(settings).textDirection,
					class: normalizeClass({ [unref(histoireConfig).theme.darkClass]: unref(isDark) }),
					onReady
				}, null, 8, [
					"variant",
					"story",
...
var _hoisted_3$3 = { class: "htw-flex htw-w-0 htw-flex-1 htw-mx-4" };
var margin = 16;
var gap = 16;
var _sfc_main$11 = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		const gridTemplateWidth = computed(() => {
			if (storyStore.currentStory.layout.type !== "grid") return;
			const layoutWidth = storyStore.currentStory.layout.width;
			if (!layoutWidth) return "200px";
			if (typeof layoutWidth === "number") return `${layoutWidth}px`;
			return layoutWidth;
		});
		...
		function updateSize() {
			...
			if (gridTemplateWidth.value.endsWith("%")) gridColumnWidth.value = viewWidth.value * Number.parseInt(gridTemplateWidth.value) / 100 - gap;
			else gridColumnWidth.value = Number.parseInt(gridTemplateWidth.value);
		}
		onMounted(() => {
			updateSize();
		});
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1$10, [!unref(isMobile) ? (openBlock(), createElementBlock("div", _hoisted_2$4, [
				...
				class: "htw-m-auto",
				style: normalizeStyle({ minHeight: `${unref(storyStore).currentStory.variants.length / countPerRow.value * (maxItemHeight.value + gap) - gap}px` })
			}, [createBaseVNode("div", {
				ref_key: "gridEl",
				ref: gridEl,
				class: "htw-grid htw-gap-4 htw-my-4",
				style: normalizeStyle({ gridTemplateColumns: `repeat(${columnCount.value}, ${gridColumnWidth.value}px)` })
...
var StoryVariantListItem = /* @__PURE__ */ _export_sfc(/* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		useCssVars((_ctx) => ({ "ab2181a2": unref(variant).iconColor }));
		const { variant } = toRefs(__props);
		const { isActive, targetRoute } = useCurrentVariantRoute(variant);
		const el = ref();
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", {
				...
				default: withCtx(({ active }) => [createVNode(unref(Icon), {
					icon: unref(variant).icon ?? "carbon:cube",
				...
				}, null, 8, ["icon", "class"]), createBaseVNode("span", _hoisted_1$9, toDisplayString(unref(variant).title), 1)]),
				_: 1
			}, 8, ["to", "is-active"])], 512);
		};
	}
...
var _hoisted_4$2 = { class: "htw-ml-auto htw-opacity-70 htw-flex htw-gap-1" };
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			...
			return openBlock(), createBlock(_component_VDropdown, {
				...
				popper: withCtx(({ hide }) => [createBaseVNode("div", _hoisted_1$8, [
					createVNode(_sfc_main$17, {
						...
						default: withCtx(() => [..._cache[3] || (_cache[3] = [createTextVNode(" Rotate ", -1)])]),
						_: 1
					}, 8, ["modelValue"]),
					...
					(openBlock(true), createElementBlock(Fragment, null, renderList(unref(histoireConfig).responsivePresets, (preset, index) => {
						return openBlock(), createElementBlock("button", {
							key: index,
							class: normalizeClass(["htw-px-4 htw-py-3 htw-cursor-pointer htw-text-left htw-flex htw-gap-4", [unref(settings).responsiveWidth === preset.width && unref(settings).responsiveHeight === preset.height ? "htw-bg-primary-500 hover:htw-bg-primary-600 htw-text-white dark:htw-text-black" : "htw-bg-transparent hover:htw-bg-primary-100 dark:hover:htw-bg-primary-700"]]),
							onClick: ($event) => {
								unref(settings).responsiveWidth = preset.width;
								unref(settings).responsiveHeight = preset.height;
								hide();
							}
						}, [createTextVNode(toDisplayString(preset.label) + " ", 1), createBaseVNode("span", _hoisted_4$2, [
							preset.width ? (openBlock(), createElementBlock("span", _hoisted_5$2, [createTextVNode(toDisplayString(preset.width), 1), !preset.height ? (openBlock(), createElementBlock("span", _hoisted_6, "px")) : createCommentVNode("", true)])) : createCommentVNode("", true),
							preset.width && preset.height ? (openBlock(), createElementBlock("span", _hoisted_7, "x")) : createCommentVNode("", true),
							preset.height ? (openBlock(), createElementBlock("span", _hoisted_8, [createTextVNode(toDisplayString(preset.height), 1), !preset.width ? (openBlock(), createElementBlock("span", _hoisted_9, "px")) : createCommentVNode("", true)])) : createCommentVNode("", true)
						])], 10, _hoisted_3$2);
					}), 128))
				])]),
				default: withCtx(() => [withDirectives((openBlock(), createElementBlock("div", { class: normalizeClass(["htw-flex htw-items-center htw-gap-1 htw-h-full htw-px-2 htw-group", { "htw-cursor-pointer hover:htw-text-primary-500": unref(histoireConfig).responsivePresets?.length }]) }, [createVNode(unref(Icon), {
					icon: "carbon:devices",
					class: "htw-w-4 htw-h-4 htw-opacity-50 group-hover:htw-opacity-100"
				}), createVNode(unref(Icon), {
					icon: "carbon:caret-down",
					class: "htw-w-4 htw-h-4 htw-opacity-50 group-hover:htw-opacity-100"
				})], 2)), [[_directive_tooltip, "Responsive sizes"]])]),
				_: 1
			}, 8, ["disabled"]);
		};
	}
...
var _sfc_main$8 = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1$7, [createVNode(unref(Icon), {
				icon: __props.variant.icon ?? "carbon:cube",
				class: normalizeClass(["htw-w-4 htw-h-4 htw-opacity-50", [__props.variant.iconColor ? "bind-icon-color" : "htw-text-gray-500"]])
			}, null, 8, ["icon", "class"]), createBaseVNode("span", null, toDisplayString(__props.variant.title), 1)]);
		};
	}
});
//#endregion
...
var StoryResponsivePreview = /* @__PURE__ */ _export_sfc(/* @__PURE__ */ defineComponent({
	...
	props: { variant: {} },
	setup(__props) {
		useCssVars((_ctx) => ({ "v5f6f4ee9": unref(settings).backgroundColor }));
		const props = __props;
		const settings = usePreviewSettingsStore().currentSettings;
		...
		function useDragger(el, value, min, max, axis) {
			function onMouseDown(event) {
				...
				resizing.value = true;
				const removeListeners = [addWindowListener("mousemove", onMouseMove), addWindowListener("mouseup", onMouseUp)];
				function onMouseMove(event2) {
					...
					if (Math.abs(value.value - (snapTarget - 67)) < 16) value.value = null;
				}
				function onMouseUp() {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1$5, [isResponsiveEnabled.value ? (openBlock(), createElementBlock("div", _hoisted_2$2, [createVNode(HatchedPattern, { class: "htw-w-full htw-h-full htw-text-black/[1%] dark:htw-text-white/[1%]" })])) : createCommentVNode("", true), createBaseVNode("div", {
				ref_key: "previewWrapper",
				ref: previewWrapper,
				class: "htw-h-full htw-overflow-auto htw-relative"
			}, [createBaseVNode("div", { class: normalizeClass(["htw-overflow-hidden htw-bg-white dark:htw-bg-gray-700 htw-rounded-lg htw-relative", isResponsiveEnabled.value ? {
				"htw-w-fit": !!finalWidth.value,
				"htw-h-fit": !!finalHeight.value,
				"htw-h-full": !finalHeight.value
			} : "htw-h-full"]) }, [createBaseVNode("div", _hoisted_3$1, [
				unref(settings).checkerboard ? (openBlock(), createBlock(CheckerboardPattern, {
					key: 0,
					class: "htw-absolute htw-inset-0 htw-w-full htw-h-full htw-text-gray-500/20"
				})) : createCommentVNode("", true),
				createBaseVNode("div", _hoisted_4$1, [createBaseVNode("div", _hoisted_5$1, [_cache[0] || (_cache[0] = createBaseVNode("div", { class: "htw-absolute htw-inset-0" }, null, -1)), renderSlot(_ctx.$slots, "default", {
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(StoryResponsivePreview, {
				...
				default: withCtx(({ isResponsiveEnabled, finalWidth, finalHeight }) => [createBaseVNode("div", {
...
var _sfc_main$4 = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		const iframe = ref();
		function syncState() {
			if (iframe.value && props.variant.previewReady) iframe.value.contentWindow.postMessage({
				type: STATE_SYNC,
		...
		function syncSettings() {
			if (iframe.value) iframe.value.contentWindow.postMessage({
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(StoryResponsivePreview, {
				...
				default: withCtx(({ isResponsiveEnabled, finalWidth, finalHeight, resizing }) => [createBaseVNode("iframe", {
					ref_key: "iframe",
					ref: iframe,
...
var _sfc_main$3 = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1$3, [!unref(isMobile) ? (openBlock(), createElementBlock("div", _hoisted_2$1, [
				...
				createCommentVNode("", true)
			])) : createCommentVNode("", true), __props.story.layout?.iframe === false ? (openBlock(), createBlock(_sfc_main$5, {
				key: 1,
				story: __props.story,
				variant: __props.variant
...
var _hoisted_4 = { class: "htw-h-full htw-overflow-y-auto" };
var _hoisted_5 = {
	key: 0,
...
var StoryVariantSingle = /* @__PURE__ */ _export_sfc(/* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		useCssVars((_ctx) => ({ "v41c4d268": variant.value?.iconColor }));
		const storyStore = useStoryStore();
		...
		return (_ctx, _cache) => {
			return hasSingleVariant.value && variant.value ? (openBlock(), createElementBlock("div", _hoisted_1$2, [createVNode(_sfc_main$3, {
				variant: variant.value,
				story: unref(storyStore).currentStory
			}, null, 8, ["variant", "story"])])) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [unref(isMobile) ? (openBlock(), createElementBlock("div", _hoisted_2, [createBaseVNode("a", {
			...
			}, [variant.value ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [createVNode(unref(Icon), {
			...
			}, null, 8, ["icon", "class"]), createTextVNode(" " + toDisplayString(variant.value.title), 1)], 64)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [createTextVNode(" Select a variant... ")], 64)), createVNode(unref(Icon), {
				icon: "carbon:chevron-sort",
				class: "htw-w-5 htw-h-5 htw-shrink-0 htw-ml-auto"
			})]), unref(storyStore).currentVariant ? (openBlock(), createElementBlock("div", _hoisted_3, [createVNode(_sfc_main$3, {
				variant: unref(storyStore).currentVariant,
				story: unref(storyStore).currentStory
			}, null, 8, ["variant", "story"])])) : createCommentVNode("", true)])) : (openBlock(), createBlock(BaseSplitPane, {
				key: 1,
				...
				first: withCtx(() => [createBaseVNode("div", _hoisted_4, [(openBlock(true), createElementBlock(Fragment, null, renderList(unref(storyStore).currentStory.variants, (v, index) => {
					return openBlock(), createBlock(StoryVariantListItem, {
						key: index,
						variant: v
					}, null, 8, ["variant"]);
				}), 128))])]),
				last: withCtx(() => [unref(storyStore).currentVariant ? (openBlock(), createElementBlock("div", _hoisted_5, [createVNode(_sfc_main$3, {
					variant: unref(storyStore).currentVariant,
					story: unref(storyStore).currentStory
...
var StoryViewer = /* @__PURE__ */ _export_sfc(/* @__PURE__ */ defineComponent({
	__name: "StoryViewer",
	setup(__props) {
		useCssVars((_ctx) => ({ "v0f021d3c": variant.value?.iconColor }));
		const storyStore = useStoryStore();
		const variant = computed(() => storyStore.currentVariant);
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock(Fragment, null, [createBaseVNode("div", _hoisted_1$1, [unref(storyStore).currentStory.layout.type === "grid" ? (openBlock(), createBlock(_sfc_main$11, { key: 0 })) : unref(storyStore).currentStory.layout.type === "single" ? (openBlock(), createBlock(StoryVariantSingle, {
				key: 1,
				onOpenVariantMenu: _cache[0] || (_cache[0] = ($event) => isMenuOpened.value = true)
			})) : createCommentVNode("", true)]), createVNode(_sfc_main$35, {
				title: "Select a variant",
				opened: isMenuOpened.value,
				onClose: closeMenu
			}, {
				default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList(unref(storyStore).currentStory.variants, (v, index) => {
					return openBlock(), createBlock(StoryVariantListItem, {
						key: index,
						variant: v
					}, null, 8, ["variant"]);
...
var _sfc_main = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		watch(() => storyStore.currentVariant, (value) => {
			if (value) storyStore.currentStory.lastSelectedVariant = value;
		}, { immediate: true });
		watch(() => [storyStore.currentStory, storyStore.currentVariant], () => {
			if (!storyStore.currentVariant) {
				...
				if (storyStore.currentStory?.variants.length === 1) setVariant(storyStore.currentStory.variants[0].id);
			}
		}, { immediate: true });
		...
		return (_ctx, _cache) => {
			return !unref(storyStore).currentStory ? (openBlock(), createBlock(BaseEmpty, {
				...
				_: 1
			})) : (openBlock(), createElementBlock("div", _hoisted_1, [unref(storyStore).currentStory.docsOnly ? (openBlock(), createElementBlock("div", {
				key: 0,
				ref_key: "docsOnlyScroller",
				ref: docsOnlyScroller,
				class: "htw-h-full htw-overflow-auto"
			}, [createVNode(_sfc_main$34, {
				story: unref(storyStore).currentStory,
				standalone: "",
			...
			}, null, 8, ["story"])], 512)) : unref(isMobile) ? (openBlock(), createBlock(StoryViewer, { key: 1 })) : (openBlock(), createBlock(BaseSplitPane, {
				key: 2,
				"save-id": "story-main",
				min: 30,
				max: 95,
				...
				last: withCtx(() => [createVNode(_sfc_main$18)]),
				_: 1
			}))]));
		};
	}
