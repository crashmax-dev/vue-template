const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./search-docs-data-Bn3uSyxn.js","./vendor-foo2EmFj.js"])))=>i.map(i=>d[i]);
import { n as ref, k as watch, c as computed, W as markRaw, d as defineComponent, a as createElementBlock, o as openBlock, a2 as renderSlot, v as withKeys, q as normalizeClass, y as createBlock, e as unref, I as Icon, f as createVNode, b as createBaseVNode, g as createCommentVNode, z as createTextVNode, t as toDisplayString, F as Fragment, x as renderList, l as useCssVars, Z as toRefs, $ as useRouter, p as withCtx, aF as useFocus, aG as refDebounced, w as withDirectives, ae as vModelText, a8 as withModifiers, _ as __vitePreload, aH as Fuse } from "./vendor-foo2EmFj.js";
import { o as onKeyboardShortcut, u as useCommandStore } from "./bundle-main-BKGWCCQG.js";
import { u as useStoryStore } from "./story-DJ3Eu-E6.js";
import "./mapping-DcJajyeP.js";
import { B as BaseEmpty } from "./BaseEmpty.vue-BBooX-TC.js";
import { _ as _export_sfc, u as useScrollOnActive, B as BaseListItemLink } from "./responsive-Hnos-DbW.js";
...
let searchData$1 = { "index": [{ "id": 0, "text": "button" }, { "id": 1, "text": "button variants" }, { "id": 2, "text": "button sizes" }], "idMap": { "0": { "id": "src-button-button-story-vue", "kind": "story" }, "1": { "id": "src-button-button-story-vue:src-button-button-story-vue-0", "kind": "variant" }, "2": { "id": "src-button-button-story-vue:src-button-button-story-vue-1", "kind": "variant" } } };
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    const DocSearchData = () => __vitePreload(() => import("./search-docs-data-Bn3uSyxn.js"), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url);
    const props = __props;
    const emit = __emit;
    function close() {
      emit("close");
