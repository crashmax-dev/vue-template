const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./button.story-DQReHXBP.js","./vendor-BeLYO1N0.js","./HomeView.vue-VLWQ0t7V.js","./story-CDdRl4ML.js","./StoryView.vue-bDPNofSY.js","./responsive-DykX9OG2.js","./BaseEmpty.vue-CgurTDSQ.js","./state-DEAPzaG6.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload, O as defineAsyncComponent, P as useDark, Q as useToggle, k as watch, R as createRouter, S as createWebHistory, U as createWebHashHistory, d as defineComponent, n as ref, V as watchEffect, W as markRaw, y as createBlock, g as createCommentVNode, X as mergeProps, Y as resolveDynamicComponent, o as openBlock, A as reactive } from "./vendor-BeLYO1N0.js";
const Comp0 = defineAsyncComponent(() => __vitePreload(() => import("./button.story-DQReHXBP.js"), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url));
  ...
  routes: [
    {
      path: "/",
      name: "home",
      component: () => __vitePreload(() => import("./HomeView.vue-VLWQ0t7V.js"), true ? __vite__mapDeps([2,3,1]) : void 0, import.meta.url)
    },
    {
      path: "/story/:storyId",
      name: "story",
      component: () => __vitePreload(() => import("./StoryView.vue-bDPNofSY.js"), true ? __vite__mapDeps([4,1,3,5,6,7]) : void 0, import.meta.url)
    }
  ]
});
const clientSupportPlugins = {
  "vanilla": () => __vitePreload(() => import("./vendor-BeLYO1N0.js").then((n) => n.aI), true ? [] : void 0, import.meta.url),
  "vue3": () => __vitePreload(() => import("./vendor-BeLYO1N0.js").then((n) => n.aJ), true ? [] : void 0, import.meta.url)
};
const __default__ = {
  inheritAttrs: false
};
