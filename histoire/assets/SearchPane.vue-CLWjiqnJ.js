...
let searchData$1 = { "index": { "reg": '{"0":1,"1":1}', "text.cfg": '{"doc":0,"opt":1}', "text.map": '[{"p":[0,1],"po":[0,1],"pot":[0,1],"poto":[0,1],"potom":[0,1]},{"t":[1],"te":[1],"tef":[1],"tefa":[1],"tefao":[1],"tefaol":[1],"tefaolt":[1]},{},{},{},{},{},{},{}]', "text.ctx": "[{}]" }, "idMap": { "0": { "id": "src-components-button-button-story-vue", "kind": "story" }, "1": { "id": "src-components-button-button-story-vue:_default", "kind": "variant" } } };
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    const DocSearchData = () => __vitePreload(() => import("./search-docs-data-c7jghrap.js"), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url);
    const props = __props;
    const emit = __emit;
    function close() {
      emit("close");
