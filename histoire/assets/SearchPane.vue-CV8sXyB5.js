const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./search-docs-data-MmDEE6hw.js","./vendor-BRmhJinp.js"])))=>i.map(i=>d[i]);
import { n as ref, k as watch, c as computed, W as markRaw, d as defineComponent, a as createElementBlock, o as openBlock, a2 as renderSlot, v as withKeys, q as normalizeClass, y as createBlock, e as unref, I as Icon, f as createVNode, b as createBaseVNode, g as createCommentVNode, z as createTextVNode, t as toDisplayString, F as Fragment, x as renderList, l as useCssVars, Z as toRefs, $ as useRouter, p as withCtx, aF as useFocus, aG as refDebounced, w as withDirectives, ae as vModelText, a8 as withModifiers, _ as __vitePreload, aH as Fuse } from "./vendor-BRmhJinp.js";
import { o as onKeyboardShortcut, u as useCommandStore } from "./bundle-main-NGj5M3QG.js";
import { u as useStoryStore } from "./story-B_FE-TCg.js";
import "./mapping-Bcwq3tS-.js";
import { B as BaseEmpty } from "./BaseEmpty.vue-DuTMU7Mr.js";
import { _ as _export_sfc, u as useScrollOnActive, B as BaseListItemLink } from "./responsive-DBsteSIg.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    const DocSearchData = () => __vitePreload(() => import("./search-docs-data-MmDEE6hw.js"), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url);
    const props = __props;
    const emit = __emit;
    function close() {
      emit("close");
