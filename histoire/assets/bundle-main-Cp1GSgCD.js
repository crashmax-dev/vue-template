const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./SearchPane.vue-qqZVYX2a.js","./vendor-BUrfcTMX.js","./story-BLiF_dmq.js","./mapping-CtRMInuV.js","./BaseEmpty.vue-DCeuV5e9.js","./responsive-D2PePAW4.js"])))=>i.map(i=>d[i]);
import { u as useEventListener, i as isRef, d as defineComponent, c as computed, a as createElementBlock, o as openBlock, r as resolveDirective, b as createBaseVNode, e as unref, f as createVNode, w as withDirectives, g as createCommentVNode, I as Icon, h as defineStore, j as useStorage, k as watch, l as useCssVars, m as useRoute, n as ref, p as withCtx, q as normalizeClass, t as toDisplayString, s as resolveComponent, v as withKeys, F as Fragment, x as renderList, y as createBlock, z as createTextVNode, A as reactive, B as normalizeStyle, T as Transition, C as vShow, D as defineAsyncComponent, _ as __vitePreload, E as useTitle, G as onMounted, H as createApp, J as createPinia, K as Gt } from "./vendor-BUrfcTMX.js";
import { i as isDark, c as customLogos, h as histoireConfig, t as toggleDark, r as router, f as files, m as mapFile, a as tree, _ as _sfc_main$c } from "./mapping-CtRMInuV.js";
import { u as useStoryStore } from "./story-BLiF_dmq.js";
import { u as useScrollOnActive, B as BaseListItemLink, _ as _export_sfc, a as _sfc_main$b, i as isMobile, b as BaseSplitPane } from "./responsive-D2PePAW4.js";
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    const SearchPane = defineAsyncComponent({
      loader: () => __vitePreload(() => import("./SearchPane.vue-qqZVYX2a.js"), true ? __vite__mapDeps([0,1,2,3,4,5]) : void 0, import.meta.url),
