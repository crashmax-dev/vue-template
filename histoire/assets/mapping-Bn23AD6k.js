const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./button.story-Bv3Y87L9.js","./vendor-dvzGQhgd.js","./HomeView.vue-CBnTKBjO.js","./story-BGKFhiQu.js","./StoryView.vue-Cno-d7Nh.js","./responsive-DnBmRY8u.js","./BaseEmpty.vue-CfncjCYS.js","./state-hDhzIA5g.js"])))=>i.map(i=>d[i]);
  ...
  routes: [
    {
      path: "/",
      name: "home",
      component: () => __vitePreload(() => import("./HomeView.vue-CBnTKBjO.js"), true ? __vite__mapDeps([2,3,1]) : void 0, import.meta.url)
    },
    {
      path: "/story/:storyId",
      name: "story",
      component: () => __vitePreload(() => import("./StoryView.vue-Cno-d7Nh.js"), true ? __vite__mapDeps([4,1,3,5,6,7]) : void 0, import.meta.url)
    }
  ]
});
