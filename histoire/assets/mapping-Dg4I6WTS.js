  ...
  routes: [
    {
      path: "/",
      name: "home",
      component: () => __vitePreload(() => import("./HomeView.vue-Cibr_1sd.js"), true ? __vite__mapDeps([2,3,1]) : void 0, import.meta.url)
    },
    {
      path: "/story/:storyId",
      name: "story",
      component: () => __vitePreload(() => import("./StoryView.vue-CjKeNX1w.js"), true ? __vite__mapDeps([4,1,3,5,6,7]) : void 0, import.meta.url)
    }
  ]
});
const clientSupportPlugins = {
  "vanilla": () => __vitePreload(() => import("./vendor-I21GC_AM.js").then((n) => n.aI), true ? [] : void 0, import.meta.url),
  "vue3": () => __vitePreload(() => import("./vendor-I21GC_AM.js").then((n) => n.aJ), true ? [] : void 0, import.meta.url)
};
const __default__ = {
  inheritAttrs: false
};
